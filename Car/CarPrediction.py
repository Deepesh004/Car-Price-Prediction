...
st.markdown(
    ...
    .reportview-container {
        background: url= ("C:/Users/deepe/Car/CCC.jpg");
...
def main ():
    ...
    p2=st.number_input("What is Distance Completed by car in Kilometer?",100,5000000,step=100)
    ...
    try:
        ...
        st.warning("Something went wromg Please try again")
